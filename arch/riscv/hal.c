...
/* Kernel stack pointer for U-mode ISR isolation.
 * When U-mode task runs, mscratch points to this value.
 * When M-mode runs, mscratch is zero.
 */
uint32_t _kernel_stack_ptr = 0;
...
void hal_hardware_init(void)
{
    ...
    /* Initialize kernel stack pointer for U-mode isolation.
